...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"tooltip-toggle"},[_c('transition',{on:{"enter":_vm.tooltipEnter,"leave":_vm.tooltipLeave}},[_c('tooltip',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],ref:"tooltip",class:_vm.tooltipClass,attrs:{"block":"tooltip-toggle"}},[_vm._v("\n            "+_vm._s(_vm.description)+"\n        ")])],1),_vm._v(" "),_c('a',{ref:"button",staticClass:"link tooltip-toggle__link",attrs:{"aria-label":_vm.label,"role":"button","tabindex":"0"},on:{"click":_vm.showTooltip,"blur":_vm.hideTooltip,"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.showTooltip($event)}}},[_c('span',{staticClass:"link__underline"}),_vm._v(" "),_vm._t("default"),_vm._v(" "),_c('icon',{staticClass:"link tooltip-toggle__icon",attrs:{"iconName":_vm.icon}})],2)],1)}
var staticRenderFns = []
